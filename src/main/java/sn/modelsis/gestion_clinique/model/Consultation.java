...
public class Consultation implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JoinTable(name = "rel_consultation__medicament", joinColumns = @JoinColumn(name = "consultation_id"), inverseJoinColumns = @JoinColumn(name = "medicament_id"))
    ...
    public String toString() {
        return "Consultation{" + "id=" + getId() + ", nO=" + getnO() + ", date='" + getDate() + "'" + "}";
    }
}