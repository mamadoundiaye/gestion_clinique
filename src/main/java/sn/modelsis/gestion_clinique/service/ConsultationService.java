package sn.modelsis.gestion_clinique.service;

import sn.modelsis.gestion_clinique.model.Consultation;
import sn.modelsis.gestion_clinique.repository.ConsultationRepository;
...
public class ConsultationService {
    ...
    public Optional<Consultation> partialUpdate(Consultation consultation) {
        ...
        return consultationRepository.findById(consultation.getId()).map(existingConsultation -> {
