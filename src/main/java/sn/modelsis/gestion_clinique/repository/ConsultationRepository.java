...
public interface ConsultationRepository extends JpaRepository<Consultation, Long> {
    @Query(value = "select distinct consultation from Consultation consultation left join fetch consultation.medicaments", countQuery = "select count(distinct consultation) from Consultation consultation")
